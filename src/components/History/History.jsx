      ...
      <div className="history_by_years">
        <div className="year2022">
          <div className="year_texts">
            ...
            <p>
              ...
              EXPECTATIONS AND DREW A HUGE ATTENTION IN THE REGION. THE FESTIVAL
              WON THE GRANT COMPETITION OF THE MINISTRY OF EDUCATION, CULTURE
              AND SPORT OF ADJARA. SINCE THEN, THE FESTIVAL HAS THE SUPPORT OF
              LOCAL AND NATIONAL MINISTRIES AND ORGANIZATIONS. THE MAIN
              FINANCIAL SUPPORTER IS SHUAKHEVI CITY HALL.
            </p>
          </div>
        ...
        <div className="year2023">
          <div className="year_texts">
            ...
            <p>
              THE SECOND FESTIVAL STEPPED UP TO AN INTERNATIONAL LEVEL . OUT OF
              DOZENS FILMS, 19 YOUNG FILMMAKERS FROM 6 COUNTRIES MADE IT INTO
              THE FINALE. (GEORGIA, UKRAINE, IRAN, JAPAN, FRANCE, INDIA). THE
              AUTHORS OF THE FILM RECEIVED VARIOUS NOMINATIONS. DUE TO AN
